...
namespace BSWebtoon.Admin.Service.AdminUploadService
{
    public class AdminUploadService
    {
        ...
        public AdminUploadService(BSRepository repository, IAdminCloudinaryService adminCloudinaryService, BSWebtoonDbContext context)
        {
        ...
        public async Task<AdminUploadComicDTO> UploadComicViewUpdateData(AdminUploadComicDTO input)
        {
            ...
            var BgCoverOutput = await _adminCloudinaryService.UploadAsync(input.BgCover);



            var ComicFigureOutput = await _adminCloudinaryService.UploadAsync(input.ComicFigure);
            var ComicNameImageOutput = await _adminCloudinaryService.UploadAsync(input.ComicNameImage);

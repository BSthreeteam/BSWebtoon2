    ...
    public class ComicService : IComicService
    {
        ...
        public void EpCreate()
        {
            var epList = new List<Episode>
            {
                ...
                new Episode(){ ComicId = 2, EpTitle = "第1話", EpCover = "https://res.cloudinary.com/dmns6twmt/image/upload/v1656600076/WornAndTornNewbie/EP01.jpg", UpdateTime=new DateTime(2021,05,05),UploadTime=new DateTime(2021,04,20),AuditTypeId=1,AuditEmployeeId=4,AuditTime=new DateTime(2021,05,05),AuditFailReason="",IsCountdownCoupon=false,IsFree=true},
                new Episode(){ ComicId = 2, EpTitle = "第2話", EpCover = "https://res.cloudinary.com/dmns6twmt/image/upload/v1656600157/WornAndTornNewbie/EP02.jpg", UpdateTime=new DateTime(2021,06,05),UploadTime=new DateTime(2021,05,01),AuditTypeId=1,AuditEmployeeId=7,AuditTime=new DateTime(2021,06,05),AuditFailReason="",IsCountdownCoupon=false,IsFree=true},
                ...
                //////41
                new Episode(){ ComicId = 41, EpTitle = "第1話", EpCover = "https://res.cloudinary.com/dmns6twmt/image/upload/v1656600076/WornAndTornNewbie/EP01.jpg", UpdateTime=new DateTime(2021,05,05),UploadTime=new DateTime(2021,04,20),AuditTypeId=1,AuditEmployeeId=1,AuditTime=new DateTime(2021,05,05),AuditFailReason="",IsCountdownCoupon=false,IsFree=true},
                new Episode(){ ComicId = 41, EpTitle = "第2話", EpCover = "https://res.cloudinary.com/dmns6twmt/image/upload/v1656600157/WornAndTornNewbie/EP02.jpg", UpdateTime=new DateTime(2021,06,05),UploadTime=new DateTime(2021,05,01),AuditTypeId=1,AuditEmployeeId=6,AuditTime=new DateTime(2021,06,05),AuditFailReason="",IsCountdownCoupon=false,IsFree=true},
                ...
                new Episode(){ ComicId = 41, EpTitle = "第4話", EpCover = "https://res.cloudinary.com/dmns6twmt/image/upload/v1656600227/WornAndTornNewbie/EP04.jpg", UpdateTime=new DateTime(2021,08,05),UploadTime=new DateTime(2021,07,01),AuditTypeId=1,AuditEmployeeId=10,AuditTime=new DateTime(2021,08,05),AuditFailReason="",IsCountdownCoupon=true,IsFree=false},
                new Episode(){ ComicId = 41, EpTitle = "第5話", EpCover = "https://res.cloudinary.com/dmns6twmt/image/upload/v1656600266/WornAndTornNewbie/EP05.jpg", UpdateTime=new DateTime(2021,09,05),UploadTime=new DateTime(2021,08,01),AuditTypeId=1,AuditEmployeeId=13,AuditTime=new DateTime(2021,09,05),AuditFailReason="",IsCountdownCoupon=true,IsFree=false},

    ...
    public class ComicService : IComicService
    {
        ...
        public void EpCreate()
        {
            var epList = new List<Episode>
            {
                ...
                //阿傑
                 //////67
                new Episode(){ ComicId = 67, EpTitle = "第1話", EpCover = "https://res.cloudinary.com/dmns6twmt/image/upload/v1656600076/WornAndTornNewbie/EP01.jpg", UpdateTime=new DateTime(2021,09,02),UploadTime=new DateTime(2021,04,20),AuditTypeId=1,AuditEmployeeId=1,AuditTime=new DateTime(2021,09,02),AuditFailReason="",IsCountdownCoupon=false,IsFree=true},

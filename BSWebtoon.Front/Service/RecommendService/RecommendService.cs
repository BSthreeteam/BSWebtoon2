    ...
    public class RecommendService : IRecommendService
    {
        ...
        public void ActivityCreate()
        {
            var activityList = new List<Activity> {
                ...
                new Activity { ActivityId=2,ActivityName = "BuildSchoolDEMO",ActivityStartTime=new DateTime(2022,06,05),ActivityEndTime=new DateTime(2022,09,31),ActivityImage="https://res.cloudinary.com/dmns6twmt/image/upload/v1657047961/ActivityIMG/AT03.png",ActivityBgColor="#CF9B68",ActivityContent="<h2>DEMO Day</h2><br><p>祝大家有個美好的未來!</p>",PrincipalEmployee=2,CreateTime=new DateTime(2022,05,28),IsDelete = true},

...
namespace BSWebtoon.Front.Service.RecommendService
{
    public class RecommendService : IRecommendService
    {
        ...
        public void ViewRecordCreate()
        {
            ...
            {
                new ViewRecord(){ /*ViewRecorId=1,*/ MemberId=1,EpId=4,ViewTime=new DateTime(2022,06,01),IsDelete=false},
                new ViewRecord(){ /*ViewRecorId=2,*/MemberId=2,EpId=8,ViewTime=new DateTime(2022,08,13),IsDelete=false},
                new ViewRecord(){ /*ViewRecorId=3,*/ MemberId=10,EpId=16,ViewTime=new DateTime(2022,03,05),IsDelete=true},
                new ViewRecord(){ /*ViewRecorId=4,*/MemberId=16,EpId=6,ViewTime=new DateTime(2022,05,06),IsDelete=false},
                new ViewRecord(){ /*ViewRecorId=5,*/ MemberId=20,EpId=3,ViewTime=new DateTime(2022,04,08),IsDelete=false},
                new ViewRecord(){ /*ViewRecorId=6,*/MemberId=19,EpId=10,ViewTime=new DateTime(2022,06,14),IsDelete=false},
                new ViewRecord(){ /*ViewRecorId=7,*/ MemberId=13,EpId=6,ViewTime=new DateTime(2022,06,25),IsDelete=false},
                new ViewRecord(){ /*ViewRecorId=8,*/MemberId=5,EpId=4,ViewTime=new DateTime(2022,03,21),IsDelete=false},
                new ViewRecord(){ /*ViewRecorId=9,*/ MemberId=3,EpId=18,ViewTime=new DateTime(2022,07,6),IsDelete=false},
                new ViewRecord(){ /*ViewRecorId=10,*/MemberId=13,EpId=13,ViewTime=new DateTime(2022,07,31),IsDelete=false},
                new ViewRecord(){ /*ViewRecorId=11,*/ MemberId=14,EpId=3,ViewTime=new DateTime(2022,07,25),IsDelete=true},
                new ViewRecord(){ /*ViewRecorId=12,*/MemberId=19,EpId=9,ViewTime=new DateTime(2022,03,24),IsDelete=false},
                new ViewRecord(){ /*ViewRecorId=13,*/ MemberId=6,EpId=12,ViewTime=new DateTime(2022,04,18),IsDelete=false},
                new ViewRecord(){ /*ViewRecorId=14,*/MemberId=7,EpId=13,ViewTime=new DateTime(2022,03,09),IsDelete=false},
                new ViewRecord(){ /*ViewRecorId=15,*/ MemberId=15,EpId=16,ViewTime=new DateTime(2022,05,15),IsDelete=true},
                new ViewRecord(){ /*ViewRecorId=16,*/MemberId=13,EpId=15,ViewTime=new DateTime(2022,05,26),IsDelete=true},
                new ViewRecord(){ /*ViewRecorId=17,*/ MemberId=10,EpId=9,ViewTime=new DateTime(2022,03,31),IsDelete=false},
                new ViewRecord(){ /*ViewRecorId=18,*/MemberId=17,EpId=10,ViewTime=new DateTime(2022,07,12),IsDelete=false},
                new ViewRecord(){ /*ViewRecorId=19,*/ MemberId=14,EpId=16,ViewTime=new DateTime(2022,08,01),IsDelete=false},
                new ViewRecord(){ /*ViewRecorId=20,*/MemberId=16,EpId=17,ViewTime=new DateTime(2022,02,20),IsDelete=false},
            };
        ...
        public void ReportCreate()
        {
            ...
            {
                new Report(){ CommentId=1,CreateTime=new DateTime(2022,07,05,12,20,00),AuditType=1,AuditEmployeeId=1,AuditTime=new DateTime(2022,07,16,10,00,00),Reason="我看他不爽!!!"},
                new Report(){ CommentId=2,CreateTime=new DateTime(2022,07,16,16,25,11),AuditType=4,AuditEmployeeId=15,AuditTime=new DateTime(2022,07,16,16,20,03),Reason="廣告訊息"},
                new Report(){ CommentId=3,CreateTime=new DateTime(2022,07,11,16,26,46),AuditType=5,AuditEmployeeId=14,AuditTime=new DateTime(2022,07,20,16,23,04),Reason="我看他不爽!!!"},
                new Report(){ CommentId=4,CreateTime=new DateTime(2022,07,15,15,56,26),AuditType=3,AuditEmployeeId=15,AuditTime=new DateTime(2022,07,22,16,21,51),Reason="我看他不爽!!!"},
                new Report(){ CommentId=5,CreateTime=new DateTime(2022,07,05,22,15,15),AuditType=2,AuditEmployeeId=5,AuditTime=new DateTime(2022,07,26,16,06,50),Reason="非法資訊"},
                new Report(){ CommentId=6,CreateTime=new DateTime(2022,07,12,23,59,56),AuditType=1,AuditEmployeeId=1,AuditTime=new DateTime(2022,07,16,16,05,16),Reason="裸露/煽情"},
                new Report(){ CommentId=7,CreateTime=new DateTime(2022,07,12,05,26,55),AuditType=3,AuditEmployeeId=2,AuditTime=new DateTime(2022,07,18,16,15,16),Reason="暴力/騷擾/仇恨言論"},
                new Report(){ CommentId=8,CreateTime=new DateTime(2022,07,14,15,22,12),AuditType=2,AuditEmployeeId=3,AuditTime=new DateTime(2022,07,19,16,21,00),Reason="個資外流"},
                new Report(){ CommentId=9,CreateTime=new DateTime(2022,07,06,20,15,45),AuditType=5,AuditEmployeeId=2,AuditTime=new DateTime(2022,07,20,16,23,05),Reason="洗版"},
                new Report(){ CommentId=10,CreateTime=new DateTime(2022,07,12,10,09,41),AuditType=4,AuditEmployeeId=16,AuditTime=new DateTime(2022,07,25,21,15,01),Reason="我看他不爽!!!"},
                new Report(){ CommentId=11,CreateTime=new DateTime(2022,07,19,05,46,30),AuditType=4,AuditEmployeeId=15,AuditTime=new DateTime(2022,07,31,09,16,15),Reason="非法資訊"},
                new Report(){ CommentId=12,CreateTime=new DateTime(2022,07,18,01,18,06),AuditType=1,AuditEmployeeId=12,AuditTime=new DateTime(2022,07,29,10,00,00),Reason="非法資訊"},
                new Report(){ CommentId=13,CreateTime=new DateTime(2022,07,16,15,46,16),AuditType=1,AuditEmployeeId=13,AuditTime=new DateTime(2022,07,25,16,03,43),Reason="廣告訊息"},
                new Report(){ CommentId=14,CreateTime=new DateTime(2022,07,09,12,45,40),AuditType=3,AuditEmployeeId=10,AuditTime=new DateTime(2022,07,20,18,08,34),Reason="廣告訊息"},
                new Report(){ CommentId=15,CreateTime=new DateTime(2022,07,15,06,21,10),AuditType=3,AuditEmployeeId=19,AuditTime=new DateTime(2022,07,27,17,10,29),Reason="非法資訊"},
                new Report(){ CommentId=16,CreateTime=new DateTime(2022,07,13,05,26,05),AuditType=1,AuditEmployeeId=20,AuditTime=new DateTime(2022,07,30,12,05,55),Reason="我看他不爽!!!"},
                new Report(){ CommentId=17,CreateTime=new DateTime(2022,07,06,22,09,06),AuditType=2,AuditEmployeeId=11,AuditTime=new DateTime(2022,07,16,12,01,02),Reason="洗版"},
                new Report(){ CommentId=18,CreateTime=new DateTime(2022,07,16,01,08,55),AuditType=1,AuditEmployeeId=5,AuditTime=new DateTime(2022,07,15,23,59,00),Reason="洗版"},
                new Report(){ CommentId=19,CreateTime=new DateTime(2022,07,06,13,14,59),AuditType=2,AuditEmployeeId=8,AuditTime=new DateTime(2022,07,16,15,51,21),Reason="洗版"},
                new Report(){ CommentId=20,CreateTime=new DateTime(2022,07,05,16,10,31),AuditType=3,AuditEmployeeId=7,AuditTime=new DateTime(2022,07,23,03,05,56),Reason="對小孩有負面影響"},
            };

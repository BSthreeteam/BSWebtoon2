    ...
    public class MemberService : IMemberService
    {
        ...
        public void MemberCreate()
        {
            var memberList = new List<Member>
            {
                ...
                new Member {/*MemberId = 11,*/AccountName ="林宗揚",NickName ="一代宗師",Balance =0,LoginTypeId =2,IsDarkTheme =true,CreateTime =new DateTime(2022,04,11),Email ="tometo871@gmail.com",AccessToken ="Iphone12" },
                ...
                new Member {/*MemberId = 13,*/AccountName ="王閣彥",NickName ="小彥",Balance =0,LoginTypeId =1,IsDarkTheme =true,CreateTime =new DateTime(2021,03,21),Email ="ppoppo00@gmail.com",AccessToken ="OPPO A55" },
                ...
                new Member {/*MemberId = 15,*/AccountName ="吳秉翰",NickName ="小翰",Balance =500,LoginTypeId =3,IsDarkTheme =true,CreateTime =new DateTime(2022,06,11),Email ="illibaa31@gmail.com",AccessToken ="Samsung Galaxy S21" },
                new Member {/*MemberId = 16,*/AccountName ="陳建宏",NickName ="五菱宏光",Balance =1000,LoginTypeId =2,IsDarkTheme =true,CreateTime =new DateTime(2022,03,20),Email ="qwq11@gmail.com",AccessToken ="Iphone8"},
                new Member {/*MemberId = 17,*/AccountName ="李文樂",NickName ="樂樂",Balance =200,LoginTypeId =3,IsDarkTheme =true,CreateTime =new DateTime(2022,01,18),Email ="mmyvc893222@gmail.com",AccessToken ="realme C21" },
                new Member {/*MemberId = 18,*/AccountName ="陳欣妤",NickName ="小妤",Balance =1000,LoginTypeId =2,IsDarkTheme =true,CreateTime =new DateTime(2022,04,10),Email ="uouqq9651@gmail.com",AccessToken ="ASUS ROG Phone 5 Pro"},
                new Member {/*MemberId = 19,*/AccountName ="范禹彤",NickName ="大禹",Balance =2300,LoginTypeId =1,IsDarkTheme =true,CreateTime =new DateTime(2022,03,21),Email ="zabcvv31564@gmail.com",AccessToken ="ASUS zenfone 7" },
                new Member {/*MemberId = 20,*/AccountName ="劉子晴",NickName ="晴天霹靂",Balance =3000,LoginTypeId =1,IsDarkTheme =false,CreateTime =new DateTime(2022,04,01),Email ="chulove9@gmail.com",AccessToken ="Iphone13"},            };

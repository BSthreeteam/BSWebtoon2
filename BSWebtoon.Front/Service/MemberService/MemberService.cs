...
namespace BSWebtoon.Front.Service.MemberService
{
    public class MemberService : IMemberService
    {
        ...
        public void MemberCreate()
        {
            ...
            {
                new Member {AccountName ="梅欣云",NickName ="欣云",Balance =500,LoginTypeId =1,IsDarkTheme =true,CreateTime =new DateTime(2022,03,21),Email ="ake4876@gmail.com",AccessToken ="Iphone12" },
                new Member {AccountName ="胡志明",NickName ="阿明",Balance =3000,LoginTypeId =1,IsDarkTheme =true,CreateTime =new DateTime(2022,05,20),Email ="jkl2345@gmail.com",AccessToken ="Iphone11"},
